...
## Stack
Next.js 15 (App Router) + TypeScript · Prisma (SQLite dev / Postgres prod) · Tailwind + shadcn/ui · Anthropic API (claude-haiku) · Vercel.
...
```
npm install
cp .env.example .env   # set DATABASE_URL, ANTHROPIC_API_KEY, ADMIN_USERNAME/PASSWORD/SESSION_SECRET
